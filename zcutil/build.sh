...
$0 [ --enable-lcov || --disable-tests ] [ --disable-mining ] [ --disable-rust ] [ --enable-proton ] [ --disable-libs ] [ MAKEARGS... ]
  ...
  If --disable-rust is passed, Zelcash is configured to not build any Rust language
  ...
  If --disable-libs is passed, Zelcash is configured to not build any libraries like
  'libzelcashconsensus'.
EOF
    exit 0
fi

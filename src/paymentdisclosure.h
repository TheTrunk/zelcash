...
#ifndef ZELCASH_PAYMENTDISCLOSURE_H
#define ZELCASH_PAYMENTDISCLOSURE_H
...
struct PaymentDisclosureInfo {
    ...
    PaymentDisclosureInfo(uint8_t v, uint256 esk, uint256 key, libzelcash::PaymentAddress zaddr) : version(v), esk(esk), joinSplitPrivKey(key), zaddr(zaddr) { }
...
#endif // ZELCASH_PAYMENTDISCLOSURE_H
